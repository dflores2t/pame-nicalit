        ...
        content: [
          {
            ...
            table: {
              ...
              body: [
                ...
                [
                  {
                    text: `Nombre y Apellidos: ${toTitleCase(
                      this.user.fullName
                    )}`,
                    colSpan: 2
                  },
                ...
                [
                  `Ex Trabajador de Nicalit: ${toTitleCase(
                    this.user.exNicalit
                  )}`,
                  `Familiar de Extrabajador: ${toTitleCase(
                ...
                [
                  {
                    text: `Nombre del Ex-Trabajador de Nicalit del cual es familiar: ${toTitleCase(
                      this.user.nameFamExTrabajador
                    )}`,
                    colSpan: 3
                  },
                  '',
                ...
                [
                  {
                    text: `Dirección Domiciliar : ${toTitleCase(
                      this.user.address
                    )}`,
                    colSpan: 3
                  },
                ...
                [
                  {
                    text: `Redes Sociales que usa para promocionar su negocio: WhatsApp: ${toTitleCase(
                      this.user.rsWhatsapp
                    )}. - Facebook: ${toTitleCase(
                      this.user.rsFacebook
                    )}. - Ninguno: ${toTitleCase(this.user.none)}`,
                    colSpan: 3
                  },
                  '',
                  ''
                ...
                [
                  {
                    text: `Titular de Cuenta Bancaria: ${toTitleCase(
                      this.user.nameTitularCuenta
                    )}`,
                    colSpan: 2
                  },
                  '',
                ...
                [
                  `Referencias Personales: ${toTitleCase(
                    this.user.referenciaPersonal
                  )}`,
          ...
          },
          {
            ...
            table: {
              ...
              body: [
                ...
                [
                  {
                    text: `Tipo de Apoyo Solicitado: ${toTitleCase(
                      this.user.aSolicitado
                    )}`,
                    colSpan: 3
                  },
                  ' ',
                ...
                [
                  {
                    text: `Descripción del Negocio: ${toTitleCase(
                      this.user.dNegocio
                    )}`,
                    colSpan: 3
                  },
                ...
                [
                  {
                    text: `Actividad Económica: ${toTitleCase(
                      this.user.aEconomica
                    )}`,
                    colSpan: 3
                  },
                  ' ',
                ...
                [
                  {
                    text: `Dirección del Negocio: ${toTitleCase(
                      this.user.dirNegocio
                    )}`,
                    colSpan: 3
                  },
                  ' ',
      ...
      pdf.getBase64(async (strPdf) => {
        ...
        try {
          ...
          if (result.status === 200 && result.data === 'ok') {
            this.message = `Estimado ${this.user.fullName} Hemos enviado tu solicitud de crédito con tu información.`
            pdf.download(customer.name)
            this.disabledModal()
          } else {
            this.message = 'Oops, Algo salió mal Inténtelo de nuevo más tarde.'
            this.disabledModal()
          }
        } catch (error) {
          setTimeout(() => {
